...
router.put('/update', async (req, res) => {
  ...
  console.log("Received updatedDeadlines:", updatedDeadlines);

  if (!Array.isArray(updatedDeadlines)) {
    return res.status(400).json({ error: 'updatedDeadlines must be an array.' });
  }
